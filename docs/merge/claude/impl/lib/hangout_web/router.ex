      ...
      <head>
        ...
        <style>
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .sidebar { width: 200px; background: #161b22; border-radius: 6px; border: 1px solid #30363d; padding: 0.75rem; overflow-y: auto; }
          ...
          .scroll-lock-banner { text-align: center; font-size: 0.75rem; color: #58a6ff; cursor: pointer; padding: 4px; background: #161b22; border-top: 1px solid #30363d; }
          ...
          @media (max-width: 640px) {
            ...
            .mobile-members { display: flex; gap: 0.5rem; padding: 0.25rem 0; font-size: 0.8rem; color: #8b949e; overflow-x: auto; }
          }
        </style>
      </head>
      <body>
